...
enum RGCareLibrary {
    ...
    static let all: [RGCareCard] = [
        RGCareCard(
            ...
            sourceIDs: ["nhs-ingrown-hairs", "aad-razor-bump-prevention", "dermnet-pfb"]
        ),
        RGCareCard(
            id: "exfoliate-timing",
            ...
            sourceIDs: ["aad-exfoliate", "aad-razor-bump-prevention", "nhs-ingrown-hairs"]
        ),
        RGCareCard(
            ...
            sourceIDs: ["jid-shaving-hair-growth", "statpearls-physiology-hair", "aad-how-to-shave"]
        ),
        RGCareCard(
            id: "patch-test-cream",
            ...
            sourceIDs: ["fda-hair-products", "medlineplus-depilatory", "dermnet-acd"]
        ),
        RGCareCard(
            id: "sun-after-wax",
            ...
            sourceIDs: ["dermnet-waxing", "nhs-sun-safety", "aad-sunscreen-faqs"]
        ),
        RGCareCard(
            id: "epilator-hygiene",
            ...
            sourceIDs: ["fda-using-cosmetics-safely", "medlineplus-folliculitis", "hair-removal-review"]
        ),
        RGCareCard(
            ...
            sourceIDs: ["medlineplus-folliculitis", "dermnet-folliculitis", "nhs-boils", "aad-keratosis-pilaris"]
        ),
        RGCareCard(
            id: "pcos-growth",
            ...
            sourceIDs: ["nhs-pcos", "nhs-hirsutism", "medlineplus-unwanted-hair"]
        ),
        RGCareCard(
            id: "blade-life",
            ...
            sourceIDs: ["aad-how-to-shave", "aad-healthy-beard"]
        ),
        RGCareCard(
            id: "grain-direction",
            ...
            sourceIDs: ["aad-how-to-shave", "aad-razor-bump-prevention", "dermnet-pfb"]
        ),
        RGCareCard(
            id: "wax-hair-length",
            ...
            sourceIDs: ["dermnet-waxing", "hair-removal-review"]
        ),
        RGCareCard(
            id: "sugaring-vs-wax",
            ...
            sourceIDs: ["hair-removal-review", "dermnet-waxing"]
        ),
        RGCareCard(
            id: "shave-prep-warm",
        ...
        RGCareCard(
            ...
            sourceIDs: ["aad-razor-bump-remedies", "dermnet-pfb", "nhs-emollients"]
        ),
        RGCareCard(
            id: "underarm-care",
            ...
            sourceIDs: ["aad-remove-unwanted-hair", "aad-razor-bump-prevention"]
        ),
        RGCareCard(
            id: "bikini-care",
            ...
            sourceIDs: ["aad-trimming-pubic-hair", "nhs-ingrown-hairs"]
        ),
        RGCareCard(
            id: "leg-care",
            ...
            sourceIDs: ["aad-how-to-shave", "hair-removal-review"]
        ),
        RGCareCard(
            id: "face-care",
        ...
        RGCareCard(
            ...
            sourceIDs: ["aad-remove-unwanted-hair", "informedhealth-hair"]
        ),
        RGCareCard(
            id: "threading-basics",
            ...
            sourceIDs: ["hair-removal-review", "aad-remove-unwanted-hair"]
        ),
        RGCareCard(
            id: "electric-dry",
        ...
        RGCareCard(
            ...
            sourceIDs: ["aad-laser-hair-removal", "fda-medical-lasers", "hair-removal-review"]
        ),
        RGCareCard(
            id: "laser-prep",
            ...
            sourceIDs: ["aad-laser-hair-removal", "nhs-sun-safety", "fda-medical-lasers"]
        ),
        RGCareCard(
            id: "cream-timing",
            ...
            sourceIDs: ["medlineplus-depilatory", "fda-hair-products", "fda-cosmetics-qa"]
        ),
        RGCareCard(
            ...
            sourceIDs: ["aad-dry-skin", "nhs-emollients", "dermnet-fragrance"]
        ),
        RGCareCard(
            id: "fragrance-avoid",
            ...
            sourceIDs: ["dermnet-fragrance", "dermnet-cosmetics", "aad-dry-skin"]
        ),
        RGCareCard(
            id: "gym-after",
            ...
            sourceIDs: ["aad-workout-acne", "aad-workout-skin"]
        ),
        RGCareCard(
            id: "pool-chlorine",
            ...
            sourceIDs: ["cdc-hot-tub-rash", "aad-summer-skin"]
        ),
        RGCareCard(
            id: "shave-frequency",
        ...
        RGCareCard(
            ...
            sourceIDs: ["aad-how-to-shave", "aad-dry-skin"]
        ),
        RGCareCard(
            id: "mole-avoid",
            ...
            sourceIDs: ["aad-abcde", "aad-laser-hair-removal"]
        ),
        RGCareCard(
            id: "shared-tools",
            ...
            sourceIDs: ["cdc-hepatitis-c", "nhs-staph", "fda-using-cosmetics-safely"]
        ),
        RGCareCard(
        ...
        RGCareCard(
            ...
            sourceIDs: ["dermnet-photosensitivity", "nhs-sun-safety", "dermnet-waxing"]
        ),
        RGCareCard(
            id: "log-honestly",
